...
# 示例视频文件列表
raw_videos = [
    "/data2/S4NN-master/original_120_100_synced.avi"
    # "D:/learning/Retina/original_120_100_synced_2.avi",
    # ... 更多视频文件
]

label_videos = [
    "/data2/S4NN-master/magno_120_100.avi"
...
images, labels = next(iter(data_loader))  # image-->(1,2,100,120) labels-->（1，100，120）
